...
COQLIBS?=\
  -R "." quantum\
  -R "/home/jaapb/progs/math-comp/mathcomp" mathcomp\
  -I "."\
  -I "/home/jaapb/progs/math-comp/mathcomp"
COQCHKLIBS?=\
  -R "." quantum\
  -R "/home/jaapb/progs/math-comp/mathcomp" mathcomp
COQDOCLIBS?=\
...
install:
	cd "." && for i in $(VOFILES) $(VFILES) $(GLOBFILES) $(NATIVEFILES) $(CMOFILES) $(CMIFILES) $(CMAFILES); do \
	 install -d "`dirname "$(DSTROOT)"$(COQLIBINSTALL)/quantum/$$i`"; \
	 install -m 0644 $$i "$(DSTROOT)"$(COQLIBINSTALL)/quantum/$$i; \
	done
...
uninstall_me.sh: Makefile
	echo '#!/bin/sh' > $@
	printf 'cd "$${DSTROOT}"$(COQLIBINSTALL)/quantum && rm -f $(VOFILES) $(VFILES) $(GLOBFILES) $(NATIVEFILES) $(CMOFILES) $(CMIFILES) $(CMAFILES) && find . -type d -and -empty -delete\ncd "$${DSTROOT}"$(COQLIBINSTALL) && find "quantum" -maxdepth 0 -and -empty -exec rmdir -p \{\} \;\n' >> "$@"
...
.merlin:
	...
	@echo "B /home/jaapb/research/qoc" >> .merlin
	@echo "S /home/jaapb/research/qoc" >> .merlin
	@echo "B /home/jaapb/progs/math-comp/mathcomp" >> .merlin
	@echo "S /home/jaapb/progs/math-comp/mathcomp" >> .merlin
